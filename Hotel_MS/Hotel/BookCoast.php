      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            <img src="images/room1-coast.jpg" class="card-img-top" alt="SINGLE">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            <img src="images/room2-coast.jpg" class="card-img-top" alt="DOUBLE">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            ...
            <img src="images/room3-coast.jpeg" class="card-img-top" alt="SUITE">
            </div>
            <div class="card-body">
