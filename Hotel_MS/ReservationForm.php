...
<head>
  ...
  <title>Book Coast Whale Hotel</title>
...
<body>
  ...
  <div class="hero-section">
    <div class="hero-content">
      <h1>Escape to the Shore</h1>
      <p>Where every moment feels like paradise</p>
    </div>
  </div>
      ...
      <div class="booking-bar">
        <div class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <div class="row g-2">
              <div class="col-6"><input type="number" class="form-control" placeholder="Adults" id="adults"></div>
              <div class="col-6"><input type="number" class="form-control" placeholder="Children" id="children"></div>
            </div>
          </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            <img src="images/room1-coast.jpg" class="card-img-top" alt="Standard Room">
            <div class="card-body">
              ...
              <p class="card-text">₱5,500 <span>/ night</span></p>
              <button class="btn book-btn w-100" data-room="Standard Room" data-price="5500" data-room-id="1">
                Book Now
              </button>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            <img src="images/room2-coast.jpg" class="card-img-top" alt="Queen Room">
            <div class="card-body">
              ...
              <p class="card-text">₱9,200 <span>/ night</span></p>
              <button class="btn book-btn w-100" data-room="Queen Room" data-price="9200" data-room-id="2">
                Book Now
              </button>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card room-card">
            ...
            <img src="images/room3-coast.jpeg" class="card-img-top" alt="Family Room">
            </div>
            <div class="card-body">
              <h5 class="card-title">Family Room</h5>
              <div class="room-features">
                <span class="room-feature">5 Guests</span>
                <span class="room-feature">Sea View</span>
                <span class="room-feature">WiFi</span>
              </div>
              <p class="card-text">₱15,000 <span>/ night</span></p>
              <button class="btn book-btn w-100" data-room="Family Room" data-price="15000" data-room-id="3">
                Book Now
              </button>
            </div>
          </div>
